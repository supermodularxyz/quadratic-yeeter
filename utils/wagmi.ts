...
const allChains: Chain[] =
  process.env.NEXT_PUBLIC_ENV === 'development' ? [...testnetChains(), ...mainnetChains()] : [...mainnetChains()]

export const { chains, provider, webSocketProvider } = configureChains(allChains, [
  infuraProvider({ apiKey: process.env.NEXT_PUBLIC_INFURA_ID, priority: 0 }),
  alchemyProvider({ apiKey: process.env.NEXT_PUBLIC_ALCHEMY_ID, priority: 1 }),
