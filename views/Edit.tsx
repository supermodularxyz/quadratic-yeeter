...
const Edit = ({ burnerAddress, toggleNext }: Props) => {
  ...
  return (<>
    ...
    <div className="w-full mb-12 p-4 bg-slate-100 rounded-md">
      ...
      {useBurner && <div className='mt-8'>
        ...
        <div className='flex items-end justify-end mt-2'>
          <a className='text-red-600 hover:text-red-400 underline italic text-sm' href='#'>drain burner wallet</a>
        </div>
      </div>}
    </div>
        ...
        <form className='flex flex-col w-full items-center' onSubmit={form.handleSubmit(handleYeet)}>
          ...
          <Collapsible className='w-full'>
            <CollapsibleTrigger className='w-full mb-2'>
              <div className='flex flex-1 justify-center text-sm'><span>Advanced settings</span></div>
            </CollapsibleTrigger>
            <CollapsibleContent>
